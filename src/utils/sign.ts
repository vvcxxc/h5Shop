...
export const Login = () => {
  ...
  if(process.env.NODE_ENV == 'development'){
    ...
    Cookie.set('test_token_auth', 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..o1zj00eoXQ5-STS-8DMDSv2AQbaQdlmPJCsiROnEBFM')
