...
export const Login = () => {
  ...
  if(process.env.NODE_ENV == 'development'){
    Cookie.set('test_token_auth', 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..Qwl4FjhE-HglgrNA4sWep4XQWElitiSJFQgsdYfZiJY')
