...
export const Login = () => {
  ...
  if(process.env.NODE_ENV == 'development'){
    ...
    Cookie.set('test_token_auth', 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..OIrCuj_kMAPEtPH8i4pqKeIrjfCREGtG0PKnutF-iLM')
