...
export const Login = () => {
  ...
  if(process.env.NODE_ENV == 'development'){
    Cookie.set('test_token_auth', 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJodHRwOi8vdGVzdC5hcGkudGRpYW55aS5jb20vd2VjaGF0L3d4b2F1dGgiLCJpYXQiOjE1NzkzMjcyNzEsImV4cCI6MTU3OTY4NzI3MSwibmJmIjoxNTc5MzI3MjcxLCJqdGkiOiJ0elNmVDB0QUpYTm9vYjIxIiwic3ViIjo3NTcwLCJwcnYiOiJmNmI3MTU0OWRiOGMyYzQyYjc1ODI3YWE0NGYwMmI3ZWU1MjlkMjRkIn0.vGR5hFZffD-ycgRuIcZL0plVN70Hnovj6TlAOfFRV5U')
