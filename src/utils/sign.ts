...
export const Login = () => {
  ...
  if (process.env.NODE_ENV == 'development') {
    Cookie.set('test_token_auth', 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..KWrZRpsRSLgEh9TZwQ-2C0YXOoGnKX1CW4swH4VunbA')
  } else {
    if (type == 'wechat') {
