...
export const Login = () => {
  ...
  if (process.env.NODE_ENV == 'development') {
    Cookie.set('test_token_auth', 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..MXEbSjNEGcH1dc68VwYYzgXt44zALzno8kyV4VYQbHs')
  } else {
    if (type == 'wechat') {
