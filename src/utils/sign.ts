...
export const Login = () => {
  ...
  if(process.env.NODE_ENV == 'development'){
    ...
    Cookie.set('test_token_auth', 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..6QOC0fLMW6m5rfbAriku3gBUGd3O3ntjmcxF__jeZaU')
