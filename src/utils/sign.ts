...
export const Login = () => {
  ...
  if (process.env.NODE_ENV == 'development') {
    Cookie.set('test_token_auth', 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..iikRhNhzUaja8wrzc6mGxb4ewNPl0WaX-PnzMuDUuD0')
  } else {
    if (type == 'wechat') {
