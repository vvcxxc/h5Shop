...
export const Login = () => {
  ...
  if (process.env.NODE_ENV == 'development') {
    Cookie.set('test_token_auth', 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..cH8YanPbYGGXFGedYpUVBwot69mtvSquLuUC2D_YqGA')
  } else {
    if (type == 'wechat') {
