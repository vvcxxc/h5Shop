...
export const Login = () => {
  ...
  if(process.env.NODE_ENV == 'development'){
    Cookie.set('test_token_auth', 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..y7Mhi6DgZimR7N1RL1rzAAdXAPRB8hxGOTdoQi1FV1A')
