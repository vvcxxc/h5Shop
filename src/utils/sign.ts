...
export const Login = () => {
  ...
  if (process.env.NODE_ENV == 'development') {
    Cookie.set('test_token_auth', 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..pAdfmEvob4o_qOzEwo1_Y-wWgY78uJYuzThlPYJGVJs')
  } else {
    if (type == 'wechat') {
