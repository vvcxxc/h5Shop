...
export const Login = () => {
  ...
  if (process.env.NODE_ENV == 'development') {
    Cookie.set('test_token_auth', 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..PDcY6hOV98RY6ivzEBPvkVPGPQ4g8SI77QRkASAqTvM')
  } else {
    if (type == 'wechat') {
