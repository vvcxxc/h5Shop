...
export const Login = () => {
  ...
  if(process.env.NODE_ENV == 'development'){
    Cookie.set('test_token_auth', 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJodHRwOi8vdGVzdC5hcGkudGRpYW55aS5jb20vd2VjaGF0L3d4b2F1dGgiLCJpYXQiOjE1ODYzMjQ5MTgsImV4cCI6MTU4NjY4NDkxOCwibmJmIjoxNTg2MzI0OTE4LCJqdGkiOiI3cDRaS3AxdmxkUll2ekRSIiwic3ViIjozNjc0MSwicHJ2IjoiZjZiNzE1NDlkYjhjMmM0MmI3NTgyN2FhNDRmMDJiN2VlNTI5ZDI0ZCJ9.LgqaPyEMMkCJmJLiFt0TCMZSwN-jfzdNMBn-xA072jY')
