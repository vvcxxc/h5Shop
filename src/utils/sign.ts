...
export const Login = () => {
  ...
  if (process.env.NODE_ENV == 'development') {
    Cookie.set('test_token_auth', 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..n56rZFfzfVws8T4GVhaIwW3Ddt4LkB8PTfXUCD2FgTY')
  } else {
    if (type == 'wechat') {
