...
export const Login = () => {
  ...
  if (process.env.NODE_ENV == 'development') {
    Cookie.set('test_token_auth', 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..3fndx-PUpmLzrI9p8RS8VI_jrLGDzew-AvvdvcYV60M')
  } else {
    if (type == 'wechat') {
