...
export const Login = () => {
  ...
  if (process.env.NODE_ENV == 'development') {
    Cookie.set('test_token_auth', 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..ATF-5zEZfTv_OD3N4SNSbxn3RAdSJXSCgQ7jh_06Sfg')
  } else {
    if (type == 'wechat') {
