...
export const Login = () => {
  ...
  if(process.env.NODE_ENV == 'development'){
    ...
    Cookie.set('test_token_auth', 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..V5W2h7lMRqkmz2HmmUyehS9bFZFL2imXGhTDCjYvRCY')
