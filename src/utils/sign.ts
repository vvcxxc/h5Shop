...
export const Login = () => {
  ...
  if (process.env.NODE_ENV == 'development') {
    Cookie.set('test_token_auth', 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..qrwd7_gtKrH-hMpD-7H8-Oy102N7l3bv2L_T1lDo3kY')
  } else {
    if (type == 'wechat') {
