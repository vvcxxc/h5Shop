...
export const Login = () => {
  ...
  if (process.env.NODE_ENV == 'development') {
    Cookie.set('test_token_auth', 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..TUnlW8tJ3H0MG-lXrmlhGe_mUUfPlSckwJofVfglnls')
  } else {
    if (type == 'wechat') {
