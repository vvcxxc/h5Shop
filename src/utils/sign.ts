...
export const Login = () => {
  ...
  if(process.env.NODE_ENV == 'development'){
    Cookie.set('test_token_auth', 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJodHRwOi8vdGVzdC5hcGkudGRpYW55aS5jb20vd2VjaGF0L3d4b2F1dGgiLCJpYXQiOjE1ODE1Nzk2NDgsImV4cCI6MTU4MTkzOTY0OCwibmJmIjoxNTgxNTc5NjQ4LCJqdGkiOiJma0JzWW1TalhFeHlzeTBnIiwic3ViIjo2ODQwLCJwcnYiOiJmNmI3MTU0OWRiOGMyYzQyYjc1ODI3YWE0NGYwMmI3ZWU1MjlkMjRkIn0.YSiphNzzGngZ5_Dvib3x3CPcl0Ktz0KRHajsJG2IRlA')
