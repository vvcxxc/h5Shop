...
class PagePicker extends Component {
    ...
    componentDidMount() {
        ...
        this.setState({ dataList:  dataCity.cityData, selector: tempselector, selectorid: tempselectorid }, () => {
    ...
    onColumnChange = e => {
        ...
        if (e.detail.column == 0) {
            ...
            console.log('市：', this.state.dataList[index1].children[0].value);
            console.log('区：', this.state.dataList[index1].children[0].children[0].value);
            ...
            console.log('省：', this.state.dataList[index1].value);
            console.log('市：', this.state.dataList[index1].children[index2].value);
            console.log('区：', this.state.dataList[index1].children[index2].children[0].value);
            ...
            console.log('省：', this.state.dataList[index1].value);
            console.log('市：', this.state.dataList[index1].children[index2].value);
            console.log('区：', this.state.dataList[index1].children[index2].children[index3].value);
            let tempselectorid = [shenid, shiid, quid];
